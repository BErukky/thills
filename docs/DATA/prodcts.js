...
price:'8000 per yard',
cart:'<i class="fas fa-shopping-cart cart"></i>' 
},
{
...
{image:'photo/DBSW5432.JPG', 
  nameofcompy:'Thrills Couure',
  prname:'Feltex cotton',
rating:'<i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>',
price:'5000 per yard' ,
cart:'<i class="fas fa-shopping-cart cart"></i>'
},
...
{
  image:'photo/WCPA6726.JPG', 
  nameofcompy:'Thrills Couure',
  prname:'Premium fabrics',
rating:'<i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>',
price:'68p00 per yard',
cart:'<i class="fas fa-shopping-cart cart"></i>'
}];
